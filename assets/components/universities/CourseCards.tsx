...
export default function CourseCards({
    ...
    return (
        <div className="mt-6 space-y-8 px-6 pb-8 max-sm:px-4">
                ...
                return (
                    ...
                    >
                        ...
                        <p className="mt-1.5 flex flex-wrap items-center gap-2 text-xs max-md:gap-1">
                            ...
                            <span className="block">
                                Teaching Language:{' '}
                                <span className="text-primary-base">{courseData.teachingLanguage}</span>
                            </span>
                        </p>
                        ...
                        <div className="mt-4 flex items-center justify-between max-lg:flex-col max-lg:items-start max-lg:gap-3 max-sm:mt-4">
                            <div className="flex items-center gap-3 text-xs max-sm:flex-col max-sm:items-start max-sm:gap-1">
                                ...
                                <span className="flex items-center gap-2">
                                    Course Offerings:{' '}
                                    <span className="text-primary-base">{courseData.courseOfferings}</span>
                                </span>
                            </div>
            ...
            <div className="mt-10 flex w-full justify-center">
                <Link
                    href="/courses"
                    className="bg-primary-base/80 cursor-pointer rounded-lg px-4 py-1.5 text-lg text-white hover:bg-blue-600"
                >
                    View All Courses
                </Link>
            </div>
